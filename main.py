...
# 1) Generación de datos.
  def generar_conjunto_datos(self):
    ...
    self.dask_array = daskArray.random.randint(lowerLimit, upperLimit, size = matrixDimentions, chunks=(1000, 1000))
    printLimit = 10000
  ...
  def generar_chi_cuadrada(self):
    chi_squared_distribution = daskArray.random.chisquare(df=3, size=1000, chunks=100)
